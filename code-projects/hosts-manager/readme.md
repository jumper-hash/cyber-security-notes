...
## Configuration
	...
	-Default Subnet: The `10.129.x.x`. prefix used for short IP inputs is hardcoded in the check_ip function and can be adjusted to match other lab environments.
